...
public class PbsOauth10a implements PbsOauth {
    private boolean isAuthorizing;
    private OAuthConsumer consumer;
    private OAuthProvider provider;
    private OAuthBackoff backoff;

    @Inject
    PbsOauth10a(OAuthBackoff backoff) {
...
//                System.out.println("Engine: " + engineHeader.getValue());
        ...
        return backoff.retrieveRequestTokenWithRetry(provider, consumer, callback);
    ...
    public void retrieveAccessToken(String verifier) throws OAuthException {
        ...
        provider = backoff.retrieveAccessTokenWithRetry(provider, consumer, verifier);
