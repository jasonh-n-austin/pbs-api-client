...
public enum PbsUrl {
    ...
    TO_BE_READ(String.format("RequestType=TBRPile%s", RequestType.TO_BE_READ), Limit.ADD_LIMIT),
    BOOK_SHELF(String.format("RequestType=Bookshelf%s", RequestType.BOOK_SHELF), Limit.ADD_LIMIT),
